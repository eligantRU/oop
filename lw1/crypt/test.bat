...
FC /B %TEMP%\err.txt correctTest\correctNoParams.txt
...
IF NOT ERRORLEVEL 0 GOTO errs
FC /B %TEMP%\err.txt correctTest\correctInvalidMode.txt
IF ERRORLEVEL 1 GOTO errs
DEL %TEMP%\err.txt
DEL %TEMP%\out.txt
...
IF NOT ERRORLEVEL 0 GOTO errs
FC /B %TEMP%\err.txt correctTest\correctKey-1.txt
IF ERRORLEVEL 1 GOTO errs
DEL %TEMP%\err.txt
DEL %TEMP%\out.txt
...
IF NOT ERRORLEVEL 0 GOTO errs
FC /B %TEMP%\err.txt correctTest\correctKey270.txt
IF ERRORLEVEL 1 GOTO errs
DEL %TEMP%\err.txt
DEL %TEMP%\out.txt
...
IF NOT ERRORLEVEL 0 GOTO errs
FC /B %TEMP%\err.txt correctTest\correctKeyF.txt
IF ERRORLEVEL 1 GOTO errs
DEL %TEMP%\err.txt
DEL %TEMP%\out.txt
...
IF ERRORLEVEL 1 GOTO errs 
FC /B %TEMP%\out.txt correctTest\correctEmpty.txt 
IF ERRORLEVEL 1 GOTO errs 
DEL %TEMP%\out.txt 
...
IF ERRORLEVEL 1 GOTO errs 
FC /B %TEMP%\out.txt correctTest\correctOneLine104Crypt.txt 
IF ERRORLEVEL 1 GOTO errs 
DEL %TEMP%\out.txt 
...
IF ERRORLEVEL 1 GOTO errs 
FC /B %TEMP%\out.txt correctTest\correctOneLine104Decrypt.txt 
IF ERRORLEVEL 1 GOTO errs 
DEL %TEMP%\out.txt 
...
IF ERRORLEVEL 1 GOTO errs 
FC /B %TEMP%\out.txt correctTest\correctMultiline55Crypt.txt 
IF ERRORLEVEL 1 GOTO errs 
DEL %TEMP%\out.txt 
...
IF ERRORLEVEL 1 GOTO errs 
FC /B %TEMP%\out.txt correctTest\correctMultiline55Decrypt.txt 
IF ERRORLEVEL 1 GOTO errs 
DEL %TEMP%\out.txt 
