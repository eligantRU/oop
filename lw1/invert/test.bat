...
C:\Windows\System32\FC %TEMP%\err.txt correctTest\correctNoParams.txt
...
IF NOT ERRORLEVEL 0 GOTO errs
C:\Windows\System32\FC %TEMP%\err.txt correctTest\correctMatrix3.txt
...
IF NOT ERRORLEVEL 0 GOTO errs
C:\Windows\System32\FC %TEMP%\err.txt correctTest\correctMatrix9.txt
IF ERRORLEVEL 1 GOTO errs
DEL %TEMP%\err.txt
...
IF NOT ERRORLEVEL 0 GOTO errs
C:\Windows\System32\FC %TEMP%\err.txt correctTest\correctMatrix10.txt
IF ERRORLEVEL 1 GOTO errs
DEL %TEMP%\err.txt
...
IF ERRORLEVEL 1 GOTO errs
C:\Windows\System32\FC %TEMP%\matrix.txt correctTest\correctMatrix1.txt
IF ERRORLEVEL 1 GOTO errs
DEL %TEMP%\matrix.txt
...
IF ERRORLEVEL 1 GOTO errs
C:\Windows\System32\FC %TEMP%\matrix.txt correctTest\correctMatrix2.txt
IF ERRORLEVEL 1 GOTO errs
DEL %TEMP%\matrix.txt
...
IF ERRORLEVEL 1 GOTO errs
C:\Windows\System32\FC %TEMP%\matrix.txt correctTest\correctMatrix4.txt
IF ERRORLEVEL 1 GOTO errs
DEL %TEMP%\matrix.txt
...
IF ERRORLEVEL 1 GOTO errs
C:\Windows\System32\FC %TEMP%\matrix.txt correctTest\correctMatrix6.txt
IF ERRORLEVEL 1 GOTO errs
DEL %TEMP%\matrix.txt
...
IF ERRORLEVEL 1 GOTO errs
C:\Windows\System32\FC %TEMP%\matrix.txt correctTest\correctMatrix8.txt
IF ERRORLEVEL 1 GOTO errs
DEL %TEMP%\matrix.txt
...
IF ERRORLEVEL 1 GOTO errs
C:\Windows\System32\FC %TEMP%\matrix.txt correctTest\correctMatrix5.txt
IF ERRORLEVEL 1 GOTO errs
DEL %TEMP%\matrix.txt
...
IF ERRORLEVEL 1 GOTO errs
C:\Windows\System32\FC %TEMP%\matrix.txt correctTest\correctMatrix7.txt
IF ERRORLEVEL 1 GOTO errs
DEL %TEMP%\matrix.txt
