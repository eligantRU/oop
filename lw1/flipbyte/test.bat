...
IF NOT ERRORLEVEL 0 GOTO errs
C:\Windows\System32\FC %TEMP%\err.txt correctTest\correct-1.txt
IF ERRORLEVEL 1 GOTO err
DEL %TEMP%\err.txt
...
IF NOT ERRORLEVEL 0 GOTO errs
C:\Windows\System32\FC %TEMP%\err.txt correctTest\correct270.txt
IF ERRORLEVEL 1 GOTO err
DEL %TEMP%\err.txt
...
IF NOT ERRORLEVEL 0 GOTO errs
C:\Windows\System32\FC %TEMP%\err.txt correctTest\correctF.txt
IF ERRORLEVEL 1 GOTO err
DEL %TEMP%\err.txt
...
C:\Windows\System32\FC %TEMP%\reverse6.txt correctTest\correctReverse6.txt
IF ERRORLEVEL 1 GOTO errs
...
IF ERRORLEVEL 1 GOTO errs
C:\Windows\System32\FC %TEMP%\reverse128.txt correctTest\correctReverse128.txt
IF ERRORLEVEL 1 GOTO errs
...
IF ERRORLEVEL 1 GOTO errs
C:\Windows\System32\FC %TEMP%\reverse1.txt correctTest\correctReverse1.txt
IF ERRORLEVEL 1 GOTO errs
