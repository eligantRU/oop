...
IF ERRORLEVEL 1 GOTO errs
FC %TEMP%\elephantReplaceString.txt correctTest\correctElephantReplaceString.txt
IF ERRORLEVEL 1 GOTO errs
...
IF ERRORLEVEL 1 GOTO errs
FC %TEMP%\PonyPonyPonyReplaceString.txt correctTest\correctPonyPonyPonyReplaceString.txt
IF ERRORLEVEL 1 GOTO errs
